require("debug").log("----PATCH---" + __filename);
("use strict");
...
exports.getAppEngineLocation = function(config) {
  ...
  if (config.cloudResourceLocation && !appEngineLocation) {
    appEngineLocation = config.cloudResourceLocation;
  }

  require("debug").log("----PATCH---");
  require("debug").log(config);
  require("debug").log(appEngineLocation);
  require("debug").log("----PATCH---");
